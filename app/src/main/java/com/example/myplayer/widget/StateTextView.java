...
public class StateTextView extends TextView {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mNormalTextColor = a.getColor(R.styleable.StateTextView_normalTextColorBtn, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.StateTextView_pressedTextColorBtn, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateTextView_unableTextColorBtn, mDefaultUnableTextColor);
        setTextColor();
        ...
        mRound = a.getBoolean(R.styleable.StateTextView_roundBtn, false);
        ...
        Drawable normalTmp = a.getDrawable(R.styleable.StateTextView_normalBackgroundDrawable);
        Drawable pressedTmp = a.getDrawable(R.styleable.StateTextView_pressedBackgroundDrawable);
        mPressedBackground.setColor(mPressedBackgroundColor);
        mUnableBackground.setColor(mUnableBackgroundColor);


        Drawable pressedBackground = mPressedBackground;
        Drawable normalBackground = mNormalBackground;
        if (normalTmp != null && pressedTmp != null) {
            pressedBackground = pressedTmp;
            normalBackground = normalTmp;
        }

        //set background
        mStateBackground.addState(states[0], pressedBackground);
        mStateBackground.addState(states[1], pressedBackground);
        mStateBackground.addState(states[3], mUnableBackground);
        mStateBackground.addState(states[2], normalBackground);
