...
public class MonthView extends View {
    ...
    private void computeDate() {
        ...
        if (null != onDateScrollChangeListener) {
            onDateScrollChangeListener.onDataCurrent(centerYear, centerMonth);
        }
    }
    ...
    public interface OnDateScrollChangeListener {
        void onDataCurrent(int year, int month);
    }
